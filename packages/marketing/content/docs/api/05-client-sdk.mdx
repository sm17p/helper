...
- A `tools` object to allow the AI agent to perform actions on the customer's behalf.
- A `customerInfoUrl` to fetch the customer's information for the prompt and UI.
