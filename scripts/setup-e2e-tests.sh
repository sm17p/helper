...
echo ""
echo "📋 Next Steps:"
echo "   1. For TDD or debug mode, run the dev server before running the test command"
echo "      a. pnpm with-test-env next dev -p 3020 --turbopack"
echo "   2. Run your tests using:"
...
echo ""
echo "   3. Or use pnpm commands directly:"
