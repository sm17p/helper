...
| `currentToken` | string | Optional    | The previously used token for an anonymous session. If provided, conversation history will persist between the anonymous sessions. |
